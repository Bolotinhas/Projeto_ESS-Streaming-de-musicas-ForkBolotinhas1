...
And o usuário clica no botão de "Salvar Alterações"
...
And o usuário "Carlos1" está autenticado
And o usuário está na página de "Atualizar Conta"
When o usuário clica no botão de "Salvar Alterações"
Then o usuário deve ver a mensagem de erro "Não é possível realizar uma atualização sem preencher nenhum campo."
And o usuário continua na página de "Atualizar Conta"
And o formulário não é enviado com sucesso
...
|       password      |
| Senhasupersecreta1! |
And o usuário clica no botão de "Confirmar"
Then o usuário deve ver a mensagem de confirmação "A conta foi removida do sistema com sucesso."
