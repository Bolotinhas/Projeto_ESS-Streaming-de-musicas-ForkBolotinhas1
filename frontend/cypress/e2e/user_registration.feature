...
And o usuário clica no botão de "Cadastrar"
Then o usuário deve ver a mensagem de confirmação "Seja bem-vindo ao .WAVe."
...
And o usuário clica no botão de "Cadastrar"
Then o usuário deve ver a mensagem de erro "O campo senha não pode estar vazio."
And o usuário continua na página de "Cadastro"
And o formulário não é enviado com sucesso
